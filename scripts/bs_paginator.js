...
function bsPaginatorHelper(options){
    ...
    var self = this;
    var result = '<nav><ul class="pagination justify-content-center">';
    var i;
  
    if (!current) return '';
  
    var currentPage = '<li class="page-item active"><a class="page-link" href="' + link(current) + '">' +
    ...
    if (prevNext && current > 1) {
      result += '<li class="page-item"><a class="page-link" href="' + link(current - 1) + '">' + prevText + '</a></li>';
    }
    ...
    if (prevNext && current < total) {
      result += '<li class="page-item"><a class="page-link" href="' + link(current + 1) + '">' + nextText + '</a></li>';
    }
